...
const ListFeatured = () => {
  ...
  useEffect(() => {
    setSimilarAssets(assetsfeatured);
  }, [assetsfeatured]);
        ...
        <div>
          ...
          >
            <h6
              ...
              className="my-4"
            >
              Showing {assetsfeatured.length} projects from{" "}
              {totalAssetsFeatured}
            </h6>
            <div>
              <Pagination
                currentPage={currentPage}
                totalPages={Math.ceil(totalAssetsFeatured / 9)}
          ...
          {assetsfeatured.length > 0 ? (
            <div className="grid grid-cols-1 justify-items-center gap-8   md:grid-cols-2 lg:grid-cols-3">
              {assetsfeatured.map((asset, index) => (
                <div
                  style={{
                    position: "relative",
                  }}
          ...
          >
            ...
            >
              Showing {assetsfeatured.length} out of {totalAssetsFeatured}
            </div>
            <div>
              <Pagination
                currentPage={currentPage}
