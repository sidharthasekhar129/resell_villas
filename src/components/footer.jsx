    ...
    >
      <div className="w-full mx-auto px-4 md:px-8">
        <div
          ...
          className="md:flex md:flex-row flex-col"
        >
          <div
            style={{
              //  flex: 2,
          ...
          >
            ...
            <div className="flex-1 mt-6 md:mt-4 sm:mr-10">
              <form
                onSubmit={(e) => e.preventDefault()}
                className="flex items-center gap-x-3 md:justify-end bg-white"
              >
                <div className="relative ">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-3 py-2 text-gray-500 bg-white border-none outline-none focus:outline-none focus:border-none shadow-sm"
                    style={{
                ...
                <button
                  style={{
                    backgroundColor: "#9379B7",
                  }}
                  className="block w-auto py-3 px-4 font-medium text-sm text-center text-white  active:shadow-none shadow"
                >
                  Subscribe
                </button>
              </form>
          ...
          <div className="   mt-10 md:mt-0 flex flex-col space-y-6 ">
            <label
              style={{
                fontFamily: "Poppins, sans-serif",
                fontWeight: 600,
            ...
            <a
              href="/properties"
              className="duration-150 text-gray-300"
              style={{
                fontFamily: "Poppins, sans-serif",
                //fontWeight: 500,
                fontSize: 14,
        ...
        <div className="mt-10 py-10 border-t-2  border-b-2 border-gray-400 items-center justify-between sm:flex">
          <div
            style={{
              marginLeft: "10vw",
              marginRight: "10vw",
            }}
            className="flex flex-row items-center md:items-start justify-center md:justify-start "
          >
          ...
          <div
            ...
            //   marginLeft: "10vw",
            // }}
            className=" mx-0 sm:mx-[10vw] gap-5 sm:gap-10  flex items-center md:items-start mt-6 sm:mt-0 justify-center md:justify-start    text-gray-400"
          >
            <a
            ...
            >
              <FaLinkedinIn size={36} color="white" />
            </a>
            <a
            ...
            <a
              ...
              className="text-gray-700 transition hover:opacity-75"
            >
              <FaFacebookF size={36} color="white" />
            </a>
          </div>
        </div>
        <div className="py-10 flex flex-col md:flex-row justify-between items-center">
          ...
          >
            RERA: PRM/KA/RERA/1251/310/AG/220711/003004
          </div>
          <div
            style={{
              backgroundColor: "white",
          ...
          >
            Industrial Layout, Block 1A, Wework Prestige Atlanta, 80 feet main
            road, Koramangla
          </div>
        </div>
        <div
        ...
        >
          <p className="text-gray-300 align-center">
            © 2024 Resell.Villas All rights reserved.
          </p>
        </div>
      </div>
    </footer>
